      ...
      >
        ...
        <div className="mt-4 space-y-6">
          <div className="space-y-3">
            <h4 className="text-[13px] font-medium tracking-wide text-slate-900">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {["All", "Outstanding", "Paid", "Overdue"].map((s) => (
                <Button
                  key={s}
          ...
          <div className="flex gap-3 pt-4">
            <DialogClose asChild>
              <Button
                className="flex-1 rounded-xl bg-slate-900 font-bold text-white transition-transform active:scale-95"
                onClick={handleApply}
              >
                Apply Filters
              </Button>
