  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="group h-auto rounded-xl px-2 py-1.5 transition-colors hover:bg-slate-50"
        >
      ...
      <DropdownMenuContent
        className="w-64 rounded-xl border-slate-100 p-1.5 shadow-2xl"
        align="end"
        sideOffset={8}
      >
        ...
        <DropdownMenuItem
          onClick={() => logout()}
          className="flex cursor-pointer items-center gap-2 rounded-md px-3 py-2 text-xs font-bold text-rose-500 focus:bg-rose-50 focus:text-rose-600"
        >
