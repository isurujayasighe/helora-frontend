...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-base leading-normal text-foreground font-semibold group-data-[size=sm]/card:text-sm", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("rounded-b-md px-4 py-3 group-data-[size=sm]/card:px-4 group-data-[size=sm]/card:py-3 [.border-t]:pt-3 group-data-[size=sm]/card:[.border-t]:pt-3 flex items-center", className)}
      {...props}
    />
  )
}
